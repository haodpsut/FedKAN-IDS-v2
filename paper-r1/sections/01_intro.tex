...
cell that produced our own headline number, tuning the baseline removes $5.39$ of the
$5.49$~pp gap. We also show the companion variance-reduction claim reverses sign on two of
four cells.
...
$1{,}280$ runs, all configurations and the analysis scripts are released.
\end{itemize}
